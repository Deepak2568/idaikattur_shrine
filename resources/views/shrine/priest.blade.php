        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="{{asset('images/jvk.jpg')}}" class="img-fluid" alt="pariest" style="height: 357px;width: 357px;">
                <div class="social">
              ...
              <div class="member-info">
                <h4>Rev.Fr.S.John Vasantha Kumar</h4>
                <span>Pariest Priest</span>
                <p class="text-danger">2025 - </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="{{asset('images/dosan.jpg')}}" class="img-fluid" alt="pariest" style="height: 357px;width: 357px;">
                <div class="social">
                  <a href=""><i class="fab fa-twitter"></i></a>
                  <a href=""><i class="fab fa-facebook"></i></a>
                  <a href=""><i class="fab fa-instagram"></i></a>
              ...
              <div class="member-info">
                <h4>Rev.Fr.Immanuel Dosan</h4>
                <p class="text-danger">2020 - 2025</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="{{asset('images/jlr.jpg')}}" class="img-fluid" alt="pariest" style="height: 357px;width: 357px;">
                <div class="social">
                  <a href=""><i class="fab fa-twitter"></i></a>
                  <a href=""><i class="fab fa-facebook"></i></a>
                  <a href=""><i class="fab fa-instagram"></i></a>
