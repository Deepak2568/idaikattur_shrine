            ...
            <div class="col-md-3 text-center mb-3 mb-md-0">
                <div class="avatar-ring" style="width:120px; height:120px; margin:0 auto;">
                    @if($customer->profile_image)
                        <img src="{{ public_storage_url($customer->profile_image) }}" alt="Your profile photo" class="shadow-sm" style="width:100%; height:100%; border-radius:8px;">
                    @else
                    ...
                    <div class="row g-0 align-items-stretch">
                        ...
                        <div class="col-12 col-md-4 d-flex align-items-center justify-content-center p-4">
                            <div class="avatar-ring" aria-label="profile avatar">
                                @if($profile_image)
                                    <img src="{{ public_storage_url($profile_image) }}" alt="Profile photo" class="shadow-sm" style="width: 100%; height: 100%; border-radius: 5px;">
                                @else
                            ...
                            <div class="ms-3 d-none d-md-flex flex-column align-items-start gap-1">
                                ...
                                @endif
                                @if($recentActive)
                                    <span class="badge bg-info text-white" data-bs-toggle="tooltip" title="Active within last 7 days"><i class="fas fa-bolt me-1"></i>Recently active</span>
                                @endif
                            </div>
                        </div>
                        <!-- Details -->
            ...
            <div class="col-md-4 text-center">
                <div class="mb-3">
                    ${profile.profile_image ?
                        `<img src="${@json(url('/media'))}/${profile.profile_image}" alt="Profile" class="img-fluid" style="width: 250px; height: 250px; object-fit: fill; border-radius: 8px; border: 3px solid #dc3545; background-color: #f8f9fa;">` :
