            ...
            <div class="row align-items-center">
                <div class="col-md-3 text-center mb-3 mb-md-0">
                    @if($customer->profile_image)
                        <img src="{{ public_storage_url($customer->profile_image) }}" alt="Profile photo" class="img-fluid" style="width: 250px; height: 250px; object-fit: fill; border-radius: 8px; border: 3px solid #dc3545; background-color: #f8f9fa;">
                    @else
